class Game {
    constructor(canvas) {
        ...
        this.ui = {
            ...
            bgmInput: document.getElementById('bgm-folder-input')
        };
    ...
    bindEvents() {
        ...
        // BGM Folder handling
        this.ui.bgmInput.addEventListener('change', (e) => {
            this.sound.loadBgmFolder(e.target.files);
        });
    }
